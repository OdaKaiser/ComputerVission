...
#fi1='sucuba_left.png'
#fi2='Images/tsucuba_right.png'

fi1='mount1.jpg'
fi2='mount2.jpg'

image1=cv2.imread(fi1)
image2=cv2.imread(fi2)
...
cv2.imwrite('task2_epi_right.jpg',image2Final)
cv2.imwrite('task2_epi_left.jpg',image1Final)
